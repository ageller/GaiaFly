...
void main(void) {
	...
	if (vTeff > 0.){
		//assign the rgb from the blackbody texture
		//exagerate?
		float useTemp = clamp( (vTeff - sTeff) * Teffac + sTeff, 1000., 19000.);

		vec3 starColor = texture2D(bb, vec2(clamp(((useTemp - 1000.)/19000.),0.,1.), 0.5) ).rgb;
